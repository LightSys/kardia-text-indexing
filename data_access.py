...
class MySQLDataAccessor:
    ...
    def flush(self):
        ...
        self.database.cursor().executemany(
               ...
               "on duplicate key update e_rel_relevance = least(e_rel_relevance, %f)",  # take the lower relevance to avoid reporting relationships as too relevant
            [(t[2], username, username, t[0], t[1], t[2]) for t in set(self.pending_relationships)])  # convert to set to get rid of duplicates
